...
class Fusion(readdata):
    ...
    def forward(self):
        ...
        ''' hr_msi stream  '''
        self.hr_msi_specific_abundance=self.net_hr_msi_stream(self.tensor_hr_msi)
        
        ''' lr_hsi stream  '''
        self.lr_hsi_specific_abundance=self.net_lr_hsi_stream(self.tensor_lr_hsi)
        ...
        self.hr_msi_abundance = 0.0005 * self.hr_msi_specific_abundance + 0.0005 * self.hr_msi_share_abundance
        ''' plus to get lr_hsi abundance '''
        #self.lr_hsi_abundance = self.lr_hsi_specific_abundance + self.lr_hsi_share_abundance
        self.lr_hsi_abundance = 0.0005 * self.lr_hsi_specific_abundance + 0.0005 * self.lr_hsi_share_abundance
